 ...
 *
 * Disassembly of iASLiGJ86p.aml, Mon Dec 31 17:20:37 2018
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x0001C968 (117096)
 *     Revision         0x02
 *     Checksum         0xA1
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "DSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.PCI0.LPCB.EC0_.ADPT, FieldUnitObj)
    External (_SB_.PCI0.LPCB.EC0_.NBMO, FieldUnitObj)
    ...
    External (WMI2, DeviceObj)

    Name (SS1, Zero)
    Name (SS2, Zero)
    Name (SS3, One)
    Name (SS4, One)
    OperationRegion (GNVS, SystemMemory, 0x3AF46018, 0x06E1)
    ...
    OperationRegion (OGNS, SystemMemory, 0x3AF46FD8, 0x0C)
            ...
            Device (RHUB)
            {
                ...
                Device (HS06)
                {
                    ...
                    Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                    {
                        ...
                        If ((FPST == Zero))
                        {
                            Return (UPCX) /* \_SB_.PCI0.XHC_.RHUB.HS06._UPC.UPCX */
                        }
                    ...
                    Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                    {
                        ...
                        If ((FPST == Zero))
                        {
                            Return (PLDX) /* \_SB_.PCI0.XHC_.RHUB.HS06._PLD.PLDX */
                        }
                ...
                Device (HS08)
                {
                    ...
                    Device (WCAM)
                    {
                        ...
                        Method (_UPC, 0, Serialized)  // _UPC: USB Port Capabilities
                        {
                            ...
                            Return (UPCP) /* \_SB_.PCI0.XHC_.RHUB.HS08.WCAM._UPC.UPCP */
                        }
                        ...
                        Method (_PLD, 0, Serialized)  // _PLD: Physical Location of Device
                        {
                            ...
                            Return (PLDP) /* \_SB_.PCI0.XHC_.RHUB.HS08.WCAM._PLD.PLDP */
                        }
                    }
                }
    ...
    OperationRegion (MDBG, SystemMemory, 0x3AF33018, 0x1004)
    ...
    Scope (\)
    {
        OperationRegion (COMP, SystemMemory, 0x3AF56018, 0x0200)
        ...
        Scope (_SB.PCI0.I2C2)
        {
            Device (TPAD)
            {
                ...
                CreateWordField (SBFB, \_SB.PCI0.I2C2.TPAD._Y31._ADR, ADR0)  // _ADR: Address
                Method (_HID, 0, Serialized)  // _HID: Hardware ID
                {
                    If (~CondRefOf (TPDF))
                    {
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    If ((Arg0 == ToUUID ("3cdff6f7-4267-4555-ad05-b30a3d8938de") /* HID I2C Device */))
                    {
                        ...
                        If ((Arg2 == One))
                        {
                            Return (HID2) /* \_SB_.PCI0.I2C2.TPAD.HID2 */
                        }
                    }
                    Else
                    {
        ...
        Scope (_SB.PCI0.I2C1)
        {
            Device (TPNL)
            {
                ...
                CreateWordField (SBFB, \_SB.PCI0.I2C1.TPNL._Y32._ADR, ADR0)  // _ADR: Address
                Method (_HID, 0, Serialized)  // _HID: Hardware ID
                {
                    If (~CondRefOf (TPLF))
                    {
                ...
                Method (_DSM, 4, NotSerialized)  // _DSM: Device-Specific Method
                {
                    If ((Arg0 == ToUUID ("3cdff6f7-4267-4555-ad05-b30a3d8938de") /* HID I2C Device */))
                    {
                        ...
                        If ((Arg2 == One))
                        {
                            Return (HID2) /* \_SB_.PCI0.I2C1.TPNL.HID2 */
                        }
                    }
                    Else
                    {
            ...
            Method (CFUN, 4, Serialized)
            {
                ...
                If ((DerefOf (Arg0 [Zero]) == 0x15))
                {
                    ...
                    ElseIf ((SFUN == 0x9000))
                    {
                        ...
                        //SMD0 = Local1
                        Store(\_SB.PCI0.LPCB.EC0.RSMD(), Local1)
        ...
        Device (BAT1)
        {
            ...
            Method (BIFX, 1, NotSerialized)
            {
                ...
                If (ECOK ())
                {
                    ...
                    BMDL = Local0
                    STAX [0x02] = (^^EC0.BDC0 * BASC) /* \_SB_.PCI0.LPCB.BAT1.BASC */
                    ...
                    Local2 *= BASC /* \_SB_.PCI0.LPCB.BAT1.BASC */
                    STAX [0x03] = Local2
            ...
            Method (_BST, 0, NotSerialized)  // _BST: Battery Status
            {
                ...
                If (ECOK ())
                {
                    ...
                    PBST [One] = Local4
                    PBST [0x02] = (^^EC0.BRC0 * BASC) /* \_SB_.PCI0.LPCB.BAT1.BASC */
    ...
    Scope (_SB.PCI0.LPCB.EC0)
    {
        ...
        Device (VPC0)
        {
            ...
            Method (SMTF, 1, Serialized)
            {
                If ((Arg0 == Zero))
                {
                    Return (ATTF) /* \_SB_.PCI0.LPCB.EC0_.ATTF */
                }
                ...
                If ((Arg0 == One))
                {
                    ...
                    If ((Arg1 == 0x13))
                    {
                        If ((OSYS < 0x07D6))
                        {
                            ...
                            Local0 += 0x02
                            ^^^^IGPU.AINT (One, DerefOf (PLV1 [Local0]))
                            Return (Zero)
                        }
                    }
                }
            ...
            Method (GSBI, 1, NotSerialized)
            {
                ...
                TTFX = ATTF /* \_SB_.PCI0.LPCB.EC0_.ATTF */
                ...
                BTMX = TEMP /* \_SB_.PCI0.LPCB.EC0_.TEMP */
                CreateWordField (SBIF, 0x10, BMDX)
                BMDX = BMD0 /* \_SB_.PCI0.LPCB.EC0_.BMD0 */
                CreateWordField (SBIF, 0x12, FUDX)
                FUDX = STUD /* \_SB_.PCI0.LPCB.EC0_.STUD */
    ...
    Device (WMIP)
    {
        ...
        {
            /* 0000 */  0x46, 0x4F, 0x4D, 0x42, 0x01, 0x00, 0x00, 0x00,  // FOMB....
            /* 0008 */  0x56, 0x04, 0x00, 0x00, 0xE0, 0x13, 0x00, 0x00,  // V.......
            /* 0010 */  0x44, 0x53, 0x00, 0x01, 0x1A, 0x7D, 0xDA, 0x54,  // DS...}.T
            /* 0018 */  0x28, 0xD5, 0x89, 0x00, 0x01, 0x06, 0x18, 0x42,  // (......B
            /* 0020 */  0x10, 0x05, 0x10, 0x0A, 0xA2, 0x83, 0x42, 0x04,  // ......B.
            /* 0028 */  0x12, 0x4F, 0x24, 0x69, 0x0E, 0x60, 0x30, 0x1A,  // .O$i.`0.
            ...
            /* 0100 */  0x53, 0x28, 0xED, 0x0F, 0x82, 0xC4, 0x3B, 0x0E,  // S(....;.
            ...
            /* 0188 */  0x24, 0x44, 0x78, 0x56, 0x00, 0x0F, 0x41, 0x91,  // $DxV..A.
            /* 0190 */  0xE7, 0x07, 0xF4, 0x18, 0x38, 0x6C, 0xBC, 0x23,  // ....8l.#
            /* 0198 */  0x0A, 0x1D, 0x39, 0x7C, 0x94, 0xD3, 0x38, 0x24,  // ..9|..8$
            /* 01A0 */  0x9F, 0x2C, 0x8C, 0x70, 0xA2, 0x0F, 0x13, 0x0F,  // .,.p....
            /* 01A8 */  0x18, 0xBE, 0x1F, 0x9C, 0xD3, 0x33, 0xC3, 0x59,  // .....3.Y
            /* 01B0 */  0xBD, 0x0F, 0x78, 0x08, 0x5A, 0xA8, 0x2C, 0x80,  // ..x.Z.,.
            /* 01B8 */  0x48, 0xDC, 0x62, 0x65, 0x63, 0xB1, 0x1E, 0x04,  // H.bec...
            /* 01C0 */  0x15, 0x7E, 0x4A, 0x90, 0x47, 0x5C, 0x61, 0x9E,  // .~J.G\a.
            /* 01C8 */  0xD2, 0xD3, 0x86, 0x8F, 0x00, 0xEF, 0x14, 0x7C,  // .......|
            /* 01D0 */  0xE0, 0x82, 0xD3, 0x99, 0x84, 0xCB, 0xA4, 0x90,  // ........
            /* 01D8 */  0x48, 0x08, 0x0D, 0xC8, 0x70, 0x96, 0x05, 0x47,  // H...p..G
            /* 01E0 */  0x41, 0x7C, 0x02, 0x70, 0x64, 0x08, 0x7D, 0x4F,  // A|.pd.}O
            /* 01E8 */  0x74, 0x18, 0x40, 0x1C, 0x01, 0x3C, 0xC3, 0x13,  // t.@..<..
            /* 01F0 */  0x7A, 0x69, 0x30, 0x81, 0x23, 0x42, 0xE8, 0xFC,  // zi0.#B..
            /* 01F8 */  0xE0, 0x13, 0x03, 0x7E, 0x2C, 0x47, 0x76, 0x62,  // ...~,Gvb
            /* 0200 */  0x9E, 0x85, 0xFF, 0xFF, 0x93, 0x7D, 0xF4, 0x00,  // .....}..
            /* 0208 */  0xCB, 0xE0, 0xD8, 0x0A, 0x9F, 0x01, 0x7C, 0x04,  // ......|.
            /* 0210 */  0x08, 0x72, 0xBE, 0xC1, 0x4E, 0xD6, 0x28, 0xAF,  // .r..N.(.
            /* 0218 */  0x09, 0x1E, 0x21, 0x76, 0x30, 0xFE, 0xBD, 0xD0,  // ..!v0...
            /* 0220 */  0x71, 0x90, 0xEB, 0xC1, 0x59, 0x24, 0xE0, 0xC7,  // q...Y$..
            /* 0228 */  0x04, 0xF8, 0x57, 0x10, 0xCF, 0xE0, 0x54, 0xDE,  // ..W...T.
            /* 0230 */  0x3A, 0xDE, 0x39, 0x12, 0x58, 0xE0, 0x31, 0x01,  // :.9.X.1.
            /* 0238 */  0x14, 0x40, 0xBE, 0x14, 0xF8, 0x86, 0xF0, 0x60,  // .@.....`
            /* 0240 */  0xC0, 0xE6, 0x10, 0x22, 0x4C, 0x34, 0xC3, 0x63,  // ..."L4.c
            /* 0248 */  0xA2, 0x8D, 0x8A, 0xCA, 0x1A, 0x17, 0x6A, 0xB0,  // ......j.
            /* 0250 */  0x3E, 0xCB, 0x30, 0xEC, 0xF3, 0xB4, 0xE8, 0x51,  // >.0....Q
            /* 0258 */  0x92, 0x41, 0xBD, 0x51, 0xF8, 0x28, 0x40, 0x86,  // .A.Q.(@.
            /* 0260 */  0x8F, 0x82, 0x35, 0x5A, 0xD8, 0xA3, 0x7E, 0x9A,  // ..5Z..~.
            /* 0268 */  0xF0, 0x4D, 0xC4, 0x33, 0x33, 0x46, 0x58, 0x1F,  // .M.33FX.
            /* 0270 */  0x01, 0x80, 0x97, 0xDC, 0xE3, 0x03, 0xEA, 0x1C,  // ........
            /* 0278 */  0xE4, 0x10, 0xAB, 0xD2, 0x88, 0x22, 0x46, 0x3F,  // ....."F?
            /* 0280 */  0xF3, 0xA3, 0x88, 0x10, 0x34, 0xF0, 0x31, 0x3C,  // ....4.1<
            /* 0288 */  0x62, 0x78, 0x4E, 0x06, 0x0B, 0x64, 0x02, 0x4B,  // bxN..d.K
            /* 0290 */  0x3E, 0x41, 0xA0, 0x0E, 0x11, 0x96, 0x7A, 0x82,  // >A....z.
            /* 0298 */  0x40, 0x89, 0x83, 0xA3, 0x20, 0x3E, 0x41, 0xF8,  // @... >A.
            /* 02A0 */  0xFF, 0x1F, 0xFC, 0x04, 0x01, 0x3D, 0xE8, 0x09,  // .....=..
            /* 02A8 */  0x02, 0x14, 0x82, 0xC7, 0x0B, 0x9A, 0xA9, 0xBD,  // ........
            /* 02B0 */  0xEB, 0x1C, 0x1B, 0x6E, 0x9B, 0x0F, 0x1F, 0x0F,  // ...n....
            /* 02B8 */  0x28, 0x46, 0x3C, 0x86, 0x07, 0x16, 0xDF, 0x84,  // (F<.....
            /* 02C0 */  0x8C, 0x13, 0x39, 0xC4, 0x7B, 0x4A, 0xE8, 0x47,  // ..9.{J.G
            /* 02C8 */  0x81, 0x10, 0xD1, 0x9E, 0x6D, 0x7C, 0x88, 0x00,  // ....m|..
            /* 02D0 */  0x9C, 0x04, 0x3C, 0x44, 0x80, 0xEE, 0x2C, 0xE0,  // ..<D..,.
            /* 02D8 */  0x43, 0x04, 0xB8, 0x4E, 0x01, 0xC0, 0xEF, 0x54,  // C..N...T
            /* 02E0 */  0xC3, 0xFF, 0xFF, 0x04, 0xE6, 0xB0, 0xF4, 0x53,  // .......S
            /* 02E8 */  0x0D, 0xE2, 0x10, 0x81, 0x85, 0x79, 0x65, 0xF0,  // .....ye.
            /* 02F0 */  0xB4, 0x7C, 0x84, 0x60, 0xC7, 0x08, 0x7E, 0xAC,  // .|.`..~.
            /* 02F8 */  0xB1, 0xC4, 0x63, 0x04, 0x4A, 0x14, 0x1C, 0x05,  // ..c.J...
            /* 0300 */  0xF1, 0x58, 0x1D, 0xF8, 0x18, 0x01, 0xFD, 0x00,  // .X......
            /* 0308 */  0xE0, 0x63, 0x04, 0xFC, 0x29, 0x3D, 0x85, 0x80,  // .c..)=..
            /* 0310 */  0x6D, 0xCC, 0xF8, 0x73, 0x43, 0xA8, 0x07, 0x2F,  // m..sC../
            /* 0318 */  0x36, 0x40, 0x76, 0x84, 0x00, 0x9C, 0x04, 0x3B,  // 6@v....;
            /* 0320 */  0x42, 0x80, 0x0E, 0x96, 0x1F, 0x21, 0xC0, 0x73,  // B....!.s
            /* 0328 */  0x02, 0x80, 0xFF, 0xFF, 0x3F, 0x01, 0x80, 0x4F,  // ....?..O
            /* 0330 */  0xDE, 0xA9, 0x06, 0x7D, 0x6C, 0xF4, 0xF1, 0x01,  // ...}l...
            /* 0338 */  0xF6, 0xE0, 0xD9, 0xF9, 0x01, 0xF0, 0x75, 0x37,  // ......u7
            /* 0340 */  0x7C, 0x7E, 0x00, 0x8C, 0x8E, 0xDE, 0xE7, 0x07,  // |~......
            /* 0348 */  0xFC, 0xFF, 0xFF, 0xFC, 0x00, 0xDC, 0x4E, 0x00,  // ......N.
            /* 0350 */  0xF8, 0xD3, 0x0C, 0x78, 0x4E, 0x5D, 0x1E, 0xFD,  // ...xN]..
            /* 0358 */  0x31, 0xF9, 0xF8, 0x00, 0x18, 0x3B, 0x0C, 0x79,  // 1....;.y
            /* 0360 */  0x7E, 0x98, 0xE3, 0x03, 0x60, 0xE8, 0xFF, 0x7F,  // ~...`...
            /* 0368 */  0x7C, 0x00, 0xC7, 0x09, 0xD3, 0xC7, 0x07, 0xE0,  // |.......
            /* 0370 */  0x7A, 0x02, 0xC0, 0x07, 0x7B, 0x1D, 0x98, 0x40,  // z...{..@
            /* 0378 */  0x01, 0x8E, 0x0A, 0x8A, 0x02, 0x83, 0x3A, 0x54,  // ......:T
            /* 0380 */  0x03, 0xAE, 0xC6, 0xED, 0x51, 0x83, 0x03, 0xE6,  // ....Q...
            /* 0388 */  0x98, 0x83, 0x1D, 0x33, 0xEE, 0x02, 0x82, 0x19,  // ...3....
            /* 0390 */  0xB6, 0x8F, 0x05, 0x0F, 0xBB, 0x3E, 0x0C, 0xC7,  // .....>..
            /* 0398 */  0x31, 0xC4, 0xD3, 0xA3, 0x67, 0xEE, 0x57, 0x08,  // 1...g.W.
            /* 03A0 */  0x3B, 0x56, 0x83, 0x6B, 0x06, 0x8F, 0xD5, 0xEC,  // ;V.k....
            /* 03A8 */  0xFF, 0x7F, 0xAC, 0x06, 0xAF, 0x94, 0xE7, 0x83,  // ........
            /* 03B0 */  0x0E, 0x04, 0x3E, 0x56, 0x03, 0xFC, 0x90, 0x70,  // ..>V...p
            /* 03B8 */  0xB4, 0xD0, 0xA9, 0x06, 0xEE, 0x09, 0xD9, 0x9F,  // ........
            /* 03C0 */  0x0C, 0x8B, 0x3A, 0x93, 0xA0, 0x8E, 0x14, 0x3E,  // ..:....>
            /* 03C8 */  0x4D, 0x30, 0x54, 0x7E, 0xAA, 0xC5, 0x0C, 0x0C,  // M0T~....
            /* 03D0 */  0xFE, 0x51, 0x02, 0x7C, 0xFF, 0xFF, 0xA3, 0x04,  // .Q.|....
            /* 03D8 */  0xD8, 0xEE, 0x10, 0xEC, 0x78, 0x03, 0xBE, 0x33,  // ....x..3
            /* 03E0 */  0xC7, 0x73, 0x39, 0xF8, 0x51, 0x9F, 0xCA, 0xA3,  // .s9.Q...
            /* 03E8 */  0x06, 0x7A, 0x79, 0x89, 0x15, 0x27, 0x44, 0xCC,  // .zy..'D.
            /* 03F0 */  0x78, 0x3E, 0x0D, 0xFB, 0x6C, 0x0E, 0x3C, 0x6E,  // x>..l.<n
            /* 03F8 */  0x45, 0x1E, 0x02, 0x3F, 0x57, 0x78, 0x08, 0x7C,  // E..?Wx.|
            /* 0400 */  0x00, 0xAD, 0xCE, 0x92, 0xCC, 0xE8, 0xDC, 0x70,  // .......p
            /* 0408 */  0x47, 0x19, 0x0E, 0x76, 0xDA, 0xFC, 0x20, 0x84,  // G..v.. .
            /* 0410 */  0x53, 0x68, 0xD3, 0xA7, 0x46, 0xA3, 0x56, 0x0D,  // Sh..F.V.
            /* 0418 */  0xCA, 0xD4, 0x28, 0xD3, 0xA0, 0x56, 0x9F, 0x4A,  // ..(..V.J
            /* 0420 */  0x8D, 0x19, 0xF3, 0x31, 0x0A, 0xBF, 0x23, 0x74,  // ...1..#t
            /* 0428 */  0x50, 0x70, 0x18, 0x10, 0x2A, 0xF5, 0xB5, 0x20,  // Pp..*.. 
            /* 0430 */  0x23, 0x47, 0x02, 0x83, 0x08, 0xC8, 0x91, 0xDE,  // #G......
            /* 0438 */  0x20, 0x02, 0x72, 0x40, 0x10, 0x01, 0x39, 0xF6,  //  .r@..9.
            /* 0440 */  0x1A, 0x04, 0x64, 0x11, 0x26, 0x80, 0x98, 0xA8,  // ..d.&...
            /* 0448 */  0xD7, 0x82, 0x80, 0x2C, 0x11, 0x44, 0x40, 0x16,  // ...,.D@.
            /* 0450 */  0x6C, 0x03, 0x88, 0xC9, 0x07, 0x11, 0x90, 0xA3,  // l.......
            /* 0458 */  0x3D, 0x03, 0x04, 0x62, 0x61, 0x54, 0x02, 0xB1,  // =..baT..
            /* 0460 */  0x34, 0x25, 0x20, 0xEC, 0xFF, 0x0F               // 4% ...
        })
    }
